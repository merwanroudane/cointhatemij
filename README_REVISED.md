...
- Initial release
- Model 3 (C/S - Regime shift) only

---

**Note**: This is a complete revision that fixes critical issues in the original implementation and adds all three model specifications from the literature.
